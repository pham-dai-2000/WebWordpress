...
function styles()
{
    ...
    wp_enqueue_style('custom-font', get_template_directory_uri() . './assets/font-awesome-v5/css/fontawesome.pro.min.css');
    wp_enqueue_script('jquery');
    wp_enqueue_script('custom-slick-js', get_template_directory_uri() . '/assets/js/slick.js');
    wp_enqueue_script('animate-js', get_template_directory_uri() . '/assets/js/animate.js');
}
